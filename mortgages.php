...
<head>
    ...
    <title>Nandita Pareshkumar Amin - What is Mortgage and Why you need ?</title>
    ...
    <meta name="description"
        content="Mortgage is the Loan you pay on the remaining amount of the total house price after paying Down Payment." />
    <meta property="og:locale" content="en_CA" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Nandita Pareshkumar Amin - What is Mortgage and Why you need ?" />
    <meta property="og:description"
        content="Mortgage is the Loan you pay on the remaining amount of the total house price after paying Down Payment." />
    <meta property="og:url" content="https://nanditaamin.ca/" />
    <meta property="og:site_name" content="Nandita Pareshkumar Amin" />
    <meta property="og:image" content="https://gomilan.ca/images/social.png" />
...
<body>
                    ...
                    <div class="col-12 d-flex justify-content-start justify-content-md-end">
                        <ul class="navbar-nav mb-2 mb-lg-0 align-items-start align-items-md-center">
                            ...
                            <li class="nav-item p-1 px-2"><a class="nav-link active" aria-current="page"
                                    aria-disabled="true">Mortgages</a></li>
            ...
            <div class="row row-cols-1 row-cols-md-2 gx-md-5 gx-0 align-items-center pt-sm-5 mt-sm-5">
                <div class="col order-2 order-md-1">
                    ...
                    <h3 class="fs-4 mb-4 mt-3 blef">
                        There are many types of mortgages : Open, Closed, Convertible, Hybrid and Reverse Mortgages . Do you know how the Mortgage approval
                        process work?
                    </h3>
                    <div class="mt-3">
                ...
                <div class="col order-1 order-md-2 mt-3 mt-sm-0 d-flex  justify-content-center">
                    <div class="m-1 bg-white shadow-lg rounded-mine myps3 w-75">
                        <div class=" card card-body border-0 shadow-mine text-start mt-5 px-sm-4">
                            <h3 class="fw-bold pb-3">Mortgage calculator</h3>
                            <form id="loan-form">
                                ...
                                <div class="form-group mb-3 input-group mt-2">
                                    ...
                                    <input type="number" class="form-control no-border" id="amount"
                                        placeholder="Loan amount" value="800000">
                                </div>
                                <div class="row row-cols-2">
                                    <div class="col">
                                        ...
                                        <div class="form-group mb-3 mt-2 input-group">
                                            ...
                                            <input type="text" class="form-control no-border" id="interest"
                                                placeholder="Interest" value="1.85">
                                        </div>
                                    </div>
                                    <div class="col">
    ...
    <section>
        <div class="container">
            <div class="row justify-content-center mx-0">
                <div class="col-12 col-sm-12 col-lg-7 col-xl-8 mype">
                    <h2 class="fw-bold"> Down payment
                    </h2>
                    <p class="max-w desc mt-4">
                        A down payment is the amount of money you put towards the purchase of a home. Your lender
                        deducts the down payment from the purchase price of your home. Your mortgage covers the rest of
                        the price of the home.
                    </p>
                    <div>
                        <div class="my-5">
                            <h4 class="fw-bold">Minimum Down Payment</h4>
                            <p class="desc">
                                The minimum amount you need for your down payment depends on the purchase price of the
                                home.
                            <ul class="list-mystyle desc">
                                <li class="my-3">If the home costs $500,000 or less, you’ll need a minimum down
                                    payment
                                    of
                                    5%.</li>
                                <li class="my-3">If the home costs more than $500,000, you’ll need a minimum of 5%
                                    down
                                    on
                                    the first
                                    $500,000
                                    and
                                    10% on the remainder.</li>
                                <li class="my-3">If the home costs $1,000,000 or more, mortgage loan insurance is
                                    not
                                    available.</li>
                            </ul>
                            </p>
                    ...
                    <p class="desc">
                        If your down payment is less than 20% of the price of your home, you must purchase mortgage loan
                        insurance.
                    </p>
                    <div class="text-center">
                        <img src="images/arr.png" alt="..." class="img-fluid w-25">
                    </div>
                    <div class="mt-5 pt-5">
                        <h4 class="fw-bold">CMHC ( Canada Mortgage and Housing
                            Corporation )</h4>
                        <h6>What is CMHC and why you may need it ?</h6>
                        <p class="desc mt-3">
                            CMHC mortgage loan insurance is basiclly a Insurance for
                            your Mortgage Loan in case you are not able to pay minimum 20% of the Property price as Down
                            payment.
                        </p>
                    </div>
                    <h2 class="fw-bold mt-5 pt-5"> <img src="images/pre.png" alt="locked icon " class="img-fluid">
                        Pre Qualification & Pre Approval</h2>
                    <p class="desc mt-3">
                        Getting pre-qualified involves supplying a bank or lender with their overall financial picture,
                        including debt, income, and assets.

                        <br><br>
                        Getting pre-approved is the next step, and it's much more involved. "A pre-qualification is a
                        good indication of creditworthiness and the ability to borrow, but a pre-approval is the
                        definitive word," says Kaderabek.
                        <br><br>
                        It’s helpful and necessary to obtain both a pre-qualification and pre-approval, albeit at
                        different stages of the mortgage process.
                    </p>
                    <div class="my-5">
                        <h5 class="fw-bold">How Pre Qualification differs from Pre Approval</h5>
                        <div class="table-responsive mt-4">
                            <table class="table table-striped table-borderless">
                                <thead>
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col">Pre Qualification</th>
                                        <th scope="col">Pre Approval</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Do I need to fill out a mortgage application? </td>
                                        <td>No</td>
                                        <td>Yes</td>
                                    </tr>
                                    <tr>
                                        <td>Do I have to pay an application fee? </td>
                                        <td>No</td>
                                        <td>Maybe</td>
                                    </tr>
                                    <tr>
                                        <td>Does it require a credit history check? </td>
                                        <td>No</td>
                                        <td>Yes</td>
                                    </tr>
                                    <tr>
                                        <td>Is it based on a review of my finances? </td>
                                        <td>No</td>
                                        <td>Yes</td>
                                    </tr>
                                    <tr>
                                        <td>Does it require an estimate of my down payment amount? </td>
                                        <td>No</td>
                                        <td>Yes</td>
                                    </tr>
                                    <tr>
                                        <td>Will the lender give me a specific loan amount?</td>
                                        <td>No</td>
                                        <td>Yes</td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="my-5 py-3">
                        ...
                        <p class="desc mt-4  p-3 rounded-mine doo locked">
                            <img src="images/locked.png" alt="locked icon " class="img-fluid d-block">
                            <span class="fw-bold">Fixed-Rate Mortgage : </span> Under a fixed-rate mortgage, your
                            payment
                            amounts do not change over the length of the loan
                            term. Your payments go toward paying off the principal and interest combined.
                        </p>

                        <p class="desc mt-4  p-3 rounded-mine doo unlocked">
                            <img src="images/unlocked.png" alt="locked icon " class="img-fluid d-block">
                            <span class="fw-bold">Variable-Rate Mortgage : </span> A variable rate mortgage varies and
                            changes with the prime rate. When the prime rate is
                            adjusted based on economic factors the variable rate on your mortgage loan will be adjusted
                            as well.
                        </p>
                    </div>
                </div>
    ...
    <div class="contact_part py-5 my-5">
        <div class="row mx-0">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center align-items-center">
                <a class="text-center mylink" href="mailto:homes.milan@gmail.com">aminnandita@gmail.com</a>
                <span class="mx-3 d-none d-md-inline">|</span>
                <a href="tel:647-527-4970" class="mylink">
                647-886-4032
                </a>
            </div>
        </div>
        <div class="row row-cols-1 row-cols-md-3 mt-sm-3 mx-0 g-5">
            ...
            <div class="col-md-6 px-md-5">
                <form method="POST" action="contactForm.php">
                    <input type="hidden" name="page" value="Mortgage">
                    <div class="row">
    ...
    function haha() {
        ...
        showMoreText.style.display === "none"
        showMoreText.style.display = "none";
        buttonText.innerHTML = "Know More about CMHC";
