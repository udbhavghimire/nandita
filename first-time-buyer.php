                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0 align-items-start align-items-md-center">
                            ...
                            <li class="nav-item p-1 ps-2 ps-md-3">
                                <div class="position-relative">
                                    <div class="hahabef">
                                        <a href="tel:647-527-4970" class="btn call-btn d-none d-md-block">
                ...
                <div class="col-12 col-sm-12 col-lg-6">
                    <div class="position-relative">
                        <div class="row row-cols-1 row-cols-md-2 align-items-center gy-4">
                            <div class="col-md-12">
                                <h4 class="fw-bold step-title">1. Checking out homes you like</h4>
                                <p class="step-subtitle">
                                    This is the first step a lot of homebuyers take. This is where you start to feel
                                    what you like and don't. Remember, nearby amenities, features of the house,
                                    neighbourhood makes a huge difference!
                                </p>
                            </div>
                        </div>
                        <div class="my-2 my-md-5 py-2">
                            <img src="images/right-arr.svg" alt="right curved svg"
                                class="img-fluid position-absolute arrs" style="top: 5rem;right: -8rem;height: 18%;">
                        </div>
                        <div class="row row-cols-1 row-cols-md-2 align-items-center gy-4 bg-light rounded-pill p-5">
                            <div class="col-md-12 order-last order-md-first">
                                <h4 class="fw-bold step-title">2. Mortgage Preapproval
                                </h4>
                                <p class="step-subtitle">
                                    <span class="fw-bold">How much will bank lend you ?</span> <br>
                                    Its always a good idea to speak to mortgage agent before putting an offer. You do
                                    not wanna put an offer to a home you cannot afford. Getting a preapproval from the
                                    bank gives you confidence on the price range of the house you should buy
                                </p>
                            </div>
                        </div>
                        <div class="my-2 my-md-5  py-2">
                            <img src="images/left-arr.svg" alt="right curved svg"
                                class="img-fluid position-absolute arrs" style="top: 27rem;left: -8rem;height: 18%;">
                        </div>
                        <div class="row row-cols-1 row-cols-md-2 align-items-center gy-4">
                            <div class="col-md-12">
                                <h4 class="fw-bold step-title">3. Finding a right house - Putting an offer</h4>
                                <p class="step-subtitle">
                                    This is the most exciting time you will experience. You love the house and you want
                                    the house. But hold on, you will still need to put an offer to the seller's agent.
                                    The offer will include
                                    <br>
                                <ol>
                                    <li class="my-2">Amount of money you want to purchase the house</li>
                                    <li>Conditions : For example: Financing or Home inspection, Status certificate
                                        review
                                        etc.</li>
                                </ol>
                                </p>
                        ...
                        <div class="my-2 my-md-5  py-2">
                            <img src="images/right-arr.svg" alt="right curved svg"
                                class="img-fluid position-absolute arrs" style="top: 47rem;right: -8rem;height: 18%;">
                        </div>
                        <div class="row row-cols-1 row-cols-md-2 align-items-center gy-4  bg-light rounded-pill p-5">
                            <div class="col-md-12 order-last order-md-first">
                                <h4 class="fw-bold step-title">4. Offer acceptance or Decline</h4>
                                <p class="step-subtitle">
                                    There are two things that might happen. Either the seller will accept your offer and
                                    agrees to go ahead with the agreement of purchase and sale or they ask you to
                                    improvise your pricing or conditions.
                                    <br>
                                    At this point you have every choice to either walk away or improve your offer or
                                    make changes to the conditions
                                    <br><br>
                                    Remember, Seller can always decline your offer. In this case you have no choice but
                                    walk away.
                                </p>
                            </div>
                        </div>
                        <div class="my-2 my-md-5 py-2">
                            <img src="images/left-arr.svg" alt="right curved svg"
                                class="img-fluid position-absolute arrs" style="top: 74rem;left: -8rem;height: 18%;">
                        </div>
                        <div class="row row-cols-1 row-cols-md-2 align-items-center gy-4">
                            <div class="col-md-12">
                                <h4 class="fw-bold step-title">5. Legal stuff</h4>
                                <p class="step-subtitle">
                                    Now since your offer is accepted and you and seller are both binding to agreement of
                                    purchase and sale, the next important step is to contact your lawyer and forward the
                                    agreement. Lawyers will ask you to send in some paperwork and documents to proceed
                                    with closing .
                                    <br><br>
                                    Note: There are some closing costs you need to pay apart from Purchase price of the
                                    home. Its always a good idea to keep upto of the purchase price for closing costs
                                </p>
                            </div>
                        </div>
                        <div class="my-2 my-md-5  py-2">
                            <img src="images/right-arr.svg" alt="right curved svg"
                                class="img-fluid position-absolute arrs" style="top: 99rem;right: -8rem;height: 16%;">
                        </div>
                        <div class="row row-cols-1 row-cols-md-2 align-items-center gy-4  bg-light rounded-pill p-5">
                            <div class="col-md-12 order-last order-md-first">
                                <h4 class="fw-bold step-title">6. Rebates for First time Home Buyers</h4>
                                <p class="step-subtitle">
                                    Now, this is a part you will love. If you are a first time homeowner you will be
                                    entitled to rebates on property taxes, RRSP withdrawal as a part of Home Buyers
                                    Plan.
                                </p>
                            </div>
                        </div>
    ...
    <div class="contact_part py-5 my-5">
        <div class="row mx-0">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center align-items-center">
                <a class="text-center mylink" href="aminnandita@gmail.com">aminnandita@gmail.com</a>
